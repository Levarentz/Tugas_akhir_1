...
class BagianController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/bagians')->with('pesan',"Bagian $request->nama_bagian Berasil Disimpan");
    }
    ...
    public function update(Request $request, Bagian $bagian)
    {
        ...
        return redirect('/bagians/'.$bagian->id)->with('pesan',"Bagian $request->nama_bagian Berasil Diubah");
    }
